...
class SequentialJointTrajectoryController : public controller_interface::ControllerInterface
{
public:
  SEQUENTIAL_JOINT_TRAJECTORY_CONTROLLER__VISIBILITY_PUBLIC
  SequentialJointTrajectoryController();
...
protected:
  std::shared_ptr<sequential_joint_trajectory_controller::ParamListener> param_listener_;
  sequential_joint_trajectory_controller::Params params_;
...
private:
  ...
  SEQUENTIAL_JOINT_TRAJECTORY_CONTROLLER__VISIBILITY_LOCAL
