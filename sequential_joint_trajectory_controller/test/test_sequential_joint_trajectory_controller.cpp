...
TEST_F(SequentialJointTrajectoryControllerTest, activate_success)
{
  SetUpController();
...
TEST_F(SequentialJointTrajectoryControllerTest, update_success)
{
  SetUpController();
...
TEST_F(SequentialJointTrajectoryControllerTest, deactivate_success)
{
  SetUpController();
...
TEST_F(SequentialJointTrajectoryControllerTest, reactivate_success)
{
  SetUpController();
...
TEST_F(SequentialJointTrajectoryControllerTest, test_setting_slow_mode_service)
{
  SetUpController();
...
TEST_F(SequentialJointTrajectoryControllerTest, test_update_logic_fast)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(SequentialJointTrajectoryControllerTest, test_update_logic_slow)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(SequentialJointTrajectoryControllerTest, publish_status_success)
{
  SetUpController();
...
TEST_F(SequentialJointTrajectoryControllerTest, receive_message_and_publish_updated_status)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
