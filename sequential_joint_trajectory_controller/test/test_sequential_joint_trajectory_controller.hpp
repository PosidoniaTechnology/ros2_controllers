...
#ifndef TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_SEQUENTIAL_JOINT_TRAJECTORY_CONTROLLER_HPP_
#define TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_SEQUENTIAL_JOINT_TRAJECTORY_CONTROLLER_HPP_
...
using ControllerStateMsg = sequential_joint_trajectory_controller::SequentialJointTrajectoryController::ControllerStateMsg;
using ControllerReferenceMsg = sequential_joint_trajectory_controller::SequentialJointTrajectoryController::ControllerReferenceMsg;
using ControllerModeSrvType = sequential_joint_trajectory_controller::SequentialJointTrajectoryController::ControllerModeSrvType;
...
class TestableSequentialJointTrajectoryController : public sequential_joint_trajectory_controller::SequentialJointTrajectoryController
{
  FRIEND_TEST(SequentialJointTrajectoryControllerTest, all_parameters_set_configure_success);
  FRIEND_TEST(SequentialJointTrajectoryControllerTest, activate_success);
  FRIEND_TEST(SequentialJointTrajectoryControllerTest, reactivate_success);
  FRIEND_TEST(SequentialJointTrajectoryControllerTest, test_setting_slow_mode_service);
  FRIEND_TEST(SequentialJointTrajectoryControllerTest, test_update_logic_fast);
  FRIEND_TEST(SequentialJointTrajectoryControllerTest, test_update_logic_slow);

public:
  controller_interface::CallbackReturn on_configure(
    const rclcpp_lifecycle::State & previous_state) override
  {
    auto ret = sequential_joint_trajectory_controller::SequentialJointTrajectoryController::on_configure(previous_state);
...
class SequentialJointTrajectoryControllerFixture : public ::testing::Test
{
public:
  ...
  void SetUp()
  {
    ...
    command_publisher_ = command_publisher_node_->create_publisher<ControllerReferenceMsg>(
      "/test_sequential_joint_trajectory_controller/commands", rclcpp::SystemDefaultsQoS());
    ...
    slow_control_service_client_ = service_caller_node_->create_client<ControllerModeSrvType>(
      "/test_sequential_joint_trajectory_controller/set_slow_control_mode");
  }
...
protected:
  void SetUpController(const std::string controller_name = "test_sequential_joint_trajectory_controller")
  {
  ...
  void subscribe_and_get_messages(ControllerStateMsg & msg)
  {
    ...
    auto subscription = test_subscription_node.create_subscription<ControllerStateMsg>(
      "/test_sequential_joint_trajectory_controller/state", 10, subs_callback);
...
protected:
  ...
  std::unique_ptr<TestableSequentialJointTrajectoryController> controller_;
...
#endif  // TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_SEQUENTIAL_JOINT_TRAJECTORY_CONTROLLER_HPP_
