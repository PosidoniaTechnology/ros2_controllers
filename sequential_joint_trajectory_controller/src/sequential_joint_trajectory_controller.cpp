...
{
SequentialJointTrajectoryController::SequentialJointTrajectoryController() : controller_interface::ControllerInterface() {}
...
controller_interface::CallbackReturn SequentialJointTrajectoryController::on_init()
{
  ...
  try
  {
    param_listener_ = std::make_shared<sequential_joint_trajectory_controller::ParamListener>(get_node());
  }
...
controller_interface::CallbackReturn SequentialJointTrajectoryController::on_configure(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
  ...
  ref_subscriber_ = get_node()->create_subscription<ControllerReferenceMsg>(
    ...
    std::bind(&SequentialJointTrajectoryController::reference_callback, this, std::placeholders::_1));
...
void SequentialJointTrajectoryController::reference_callback(const std::shared_ptr<ControllerReferenceMsg> msg)
{
...
controller_interface::InterfaceConfiguration SequentialJointTrajectoryController::command_interface_configuration() const
{
...
controller_interface::CallbackReturn SequentialJointTrajectoryController::on_activate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
...
controller_interface::CallbackReturn SequentialJointTrajectoryController::on_deactivate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
...
controller_interface::return_type SequentialJointTrajectoryController::update(
