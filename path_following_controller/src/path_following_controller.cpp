...
{
PathFollowingController::PathFollowingController() : controller_interface::ControllerInterface() {}
...
controller_interface::CallbackReturn PathFollowingController::on_init()
{
  ...
  try
  {
    param_listener_ = std::make_shared<path_following_controller::ParamListener>(get_node());
  }
  ...
  const rclcpp_lifecycle::State & /*previous_state*/)
{
  ...
  ref_subscriber_ = get_node()->create_subscription<ControllerReferenceMsg>(
    ...
    std::bind(&PathFollowingController::reference_callback, this, std::placeholders::_1));
...
void PathFollowingController::reference_callback(const std::shared_ptr<ControllerReferenceMsg> msg)
{
