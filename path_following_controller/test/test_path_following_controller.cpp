...
TEST_F(PathFollowingControllerTest, activate_success)
{
  SetUpController();
...
TEST_F(PathFollowingControllerTest, update_success)
{
  SetUpController();
...
TEST_F(PathFollowingControllerTest, deactivate_success)
{
  SetUpController();
...
TEST_F(PathFollowingControllerTest, reactivate_success)
{
  SetUpController();
...
TEST_F(PathFollowingControllerTest, test_setting_slow_mode_service)
{
  SetUpController();
...
TEST_F(PathFollowingControllerTest, test_update_logic_fast)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(PathFollowingControllerTest, test_update_logic_slow)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(PathFollowingControllerTest, publish_status_success)
{
  SetUpController();
...
TEST_F(PathFollowingControllerTest, receive_message_and_publish_updated_status)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
