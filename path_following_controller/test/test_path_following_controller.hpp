...
#ifndef TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_PATH_FOLLOWING_CONTROLLER_HPP_
#define TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_PATH_FOLLOWING_CONTROLLER_HPP_
...
using ControllerStateMsg = path_following_controller::PathFollowingController::ControllerStateMsg;
using ControllerReferenceMsg = path_following_controller::PathFollowingController::ControllerReferenceMsg;
using ControllerModeSrvType = path_following_controller::PathFollowingController::ControllerModeSrvType;
...
class TestablePathFollowingController : public path_following_controller::PathFollowingController
{
  FRIEND_TEST(PathFollowingControllerTest, all_parameters_set_configure_success);
  FRIEND_TEST(PathFollowingControllerTest, activate_success);
  FRIEND_TEST(PathFollowingControllerTest, reactivate_success);
  FRIEND_TEST(PathFollowingControllerTest, test_setting_slow_mode_service);
  FRIEND_TEST(PathFollowingControllerTest, test_update_logic_fast);
  FRIEND_TEST(PathFollowingControllerTest, test_update_logic_slow);

public:
  controller_interface::CallbackReturn on_configure(
    const rclcpp_lifecycle::State & previous_state) override
  {
    auto ret = path_following_controller::PathFollowingController::on_configure(previous_state);
...
class PathFollowingControllerFixture : public ::testing::Test
{
public:
  ...
  void SetUp()
  {
    ...
    command_publisher_ = command_publisher_node_->create_publisher<ControllerReferenceMsg>(
      "/test_path_following_controller/commands", rclcpp::SystemDefaultsQoS());
    ...
    slow_control_service_client_ = service_caller_node_->create_client<ControllerModeSrvType>(
      "/test_path_following_controller/set_slow_control_mode");
  }
...
protected:
  void SetUpController(const std::string controller_name = "test_path_following_controller")
  {
  ...
  void subscribe_and_get_messages(ControllerStateMsg & msg)
  {
    ...
    auto subscription = test_subscription_node.create_subscription<ControllerStateMsg>(
      "/test_path_following_controller/state", 10, subs_callback);
...
protected:
  ...
  std::unique_ptr<TestablePathFollowingController> controller_;
...
#endif  // TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_PATH_FOLLOWING_CONTROLLER_HPP_
